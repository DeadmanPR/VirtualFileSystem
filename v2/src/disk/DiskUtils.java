...
public class DiskUtils {
	...
	public static final double PERCENTAGEOFINODEBLOCKS = 0.01;
	 ...
	 */
	public static void showFileInDiskContent(DiskUnit d) { 
	 ...
	 * @param d the DiskUnit to read from
	 */
	public static void showDiskContent(DiskUnit d) { 
	...
	public static int getNumberOfINodeBlocks(DiskUnit dUnit){
		return (int)(Math.max(1, Math.ceil(((PERCENTAGEOFINODEBLOCKS * dUnit.getCapacity()) * INodeManager.INODESIZE) / dUnit.getBlockSize())));
	}
	...
	public static int getNumberOfINodes(DiskUnit dUnit){
		return (int)(Math.max(1, (PERCENTAGEOFINODEBLOCKS * dUnit.getCapacity())));
	}
