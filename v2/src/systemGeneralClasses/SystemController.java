...
public class SystemController {
	...
	/**
	 * Initiates the processing of the command.
	 * @param cLine the command line to process
	 */
	...
	/**
	 * Creates a command based on the given command line.
	 * @param cLine the command line
