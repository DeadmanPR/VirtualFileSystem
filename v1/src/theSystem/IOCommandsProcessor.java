...
public class IOCommandsProcessor extends CommandProcessor {
	...
	/**
	 * Creates a new IOCommandsProcessor.
	 */
	...
	*/
	...
	/**
	 * Initiates the process of showing an output.
	 */
	...
	/**
	 * Checks if there is more output to process.
	 * @return true if there is more output to process, false otherwise
	 */
